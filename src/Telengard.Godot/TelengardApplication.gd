...
func _unhandled_input(event: InputEvent) -> void:
	...
	if context == InputContext.EXPLORATION:
		...
		elif event.is_action_pressed("collect_treasure"): _send_intent({"type": "collect_treasure"})
		elif event.is_action_pressed("leave_dungeon"): _send_intent({"type": "leave_dungeon"})
		elif event.is_action_pressed("stairs_down"): _send_intent({"type": "change_floor", "direction": "Down"})
		elif event.is_action_pressed("stairs_up"): _send_intent({"type": "change_floor", "direction": "Up"})
