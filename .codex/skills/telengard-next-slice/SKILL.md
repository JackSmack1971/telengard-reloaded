...
1. Read `AGENTS.md`.
2. Read `docs/tasks/README.md`, `docs/INVARIANTS.md`, and `docs/DEVELOPMENT.md`.
...
5. Read the Core Alpha/status material needed to understand the nearest milestone.
...
5. final `./eng/verify.ps1 -Mode Full` for code changes.
